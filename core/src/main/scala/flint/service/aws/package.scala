...
package object aws {
  private[aws] val instanceSpecs = Seq(
    ...
    InstanceSpecs(C38xlarge.toString, 32, GiB(60), InstanceStorageSpec(2, GiB(320)), "1.68"),
    InstanceSpecs(D28xlarge.toString, 36, GiB(244), InstanceStorageSpec(24, GiB(2000)), "5.52"),
    InstanceSpecs(I38xlarge.toString, 32, GiB(244), InstanceStorageSpec(4, GiB(1900)), "2.496"),
    InstanceSpecs(I316xlarge.toString, 64, GiB(488), InstanceStorageSpec(8, GiB(1900)), "4.992"),
    InstanceSpecs(M4Large.toString, 2, GiB(8), "0.1"),
    InstanceSpecs(P2Xlarge.toString, 4, GiB(61), "0.9"),
    InstanceSpecs(P28xlarge.toString, 32, GiB(488), "7.2"),
    InstanceSpecs(P216xlarge.toString, 64, GiB(732), "14.4"),
    InstanceSpecs(R3Large.toString, 2, GiB(15), InstanceStorageSpec(1, GiB(32)), "0.166"),
    InstanceSpecs(R38xlarge.toString, 32, GiB(244), InstanceStorageSpec(2, GiB(320)), "2.66"),
    InstanceSpecs(X116xlarge.toString, 64, GiB(976), InstanceStorageSpec(1, GiB(1920)), "6.669"),
    InstanceSpecs(X132xlarge.toString, 128, GiB(1952), InstanceStorageSpec(2, GiB(1920)), "13.338")
  )
